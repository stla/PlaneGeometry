...
```{r apollonius, fig.width=5, fig.height=5}
opar <- par(mar = c(0,0,0,0))
...
![](https://thumbs.gfycat.com/ContentZestyCutworm-size_restricted.gif)
...
```{r billiard, fig.width=5, fig.height=5}
...
```{r draw_gcircles, fig.width=5, fig.height=5}
opar <- par(mar = c(0,0,0,0), bg = "black")
...
```{r draw_schottky, fig.width=5, fig.height=5}
opar <- par(mar = c(0,0,0,0), bg = "black")
...
![](https://github.com/stla/PlaneGeometry/raw/master/inst/imgs/modularTessellation.gif)
...
```{r drawgasket, fig.height=5, fig.width=5}
...
![](https://github.com/stla/PlaneGeometry/raw/master/inst/imgs/ApollonianGasket.gif)
...
![](https://github.com/stla/PlaneGeometry/raw/master/inst/imgs/ApollonianMobius.gif)
...
![](https://github.com/stla/PlaneGeometry/raw/master/inst/imgs/Apollony.gif)
